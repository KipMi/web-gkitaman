...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'user' | 'renungan' | 'jemaat' | 'ibadah' | 'doa' | 'layananBaptis' | 'layananPernikahan' | 'konselingPendeta' | 'orangTua' | 'kegiatan' | 'karyawan'
  ...
  interface KaryawanFieldRefs {
    ...
    readonly status: FieldRef<"Karyawan", 'status'>
  ...
  export type KaryawanWhereInput = {
    ...
    status?: EnumstatusFilter<"Karyawan"> | $Enums.status
  ...
  export type KaryawanScalarWhereWithAggregatesInput = {
    ...
    status?: EnumstatusWithAggregatesFilter<"Karyawan"> | $Enums.status
